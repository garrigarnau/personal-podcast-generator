...
from app.models import User, Podcast, Metrics  # Import all models explicitly
...
async def run_async_migrations() -> None:
    ...
    This is the main function that creates an async engine and
    runs migrations using it.
    """
    # Create async engine
...
def run_migrations_online() -> None:
    ...
    In this scenario we need to create an async Engine and
